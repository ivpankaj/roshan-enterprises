        ...
        <section className="bg-slate-50 text-navy-primary py-16 relative overflow-hidden border-b border-slate-200">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10">
            ...
            <p className="text-slate-600 text-base sm:text-lg max-w-3xl mt-3 leading-relaxed">
              Specialized painting, civil work, and flooring solutions designed for residential homes, corporate offices, industrial hubs, educational institutions, and healthcare units.
            </p>
          </div>
            ...
            {INDUSTRIES_DATA.map((ind, idx) => {
              ...
              return (
                <div
                  key={ind.id}
                  id={ind.slug}
                  className={`grid grid-cols-1 lg:grid-cols-12 gap-10 items-center p-8 sm:p-12 bg-white border-2 border-slate-200 shadow-xl rounded-3xl ${
                ...
                >
                  <div className="lg:col-span-7 space-y-6">
                    ...
                    <div className="space-y-3 pt-2">
                      <h3 className="text-xs font-black uppercase text-navy-primary tracking-wider">
                        Tailored Painting & Civil Services for {ind.title}:
                      </h3>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                        {ind.keyServicesProvided.map((service, i) => (
                          <div key={i} className="flex items-center gap-2 text-xs font-semibold text-slate-700 bg-slate-50 p-2.5 border border-slate-200 rounded-xl">
