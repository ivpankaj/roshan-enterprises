        ...
        <section className="bg-slate-50 text-navy-primary py-16 relative overflow-hidden border-b border-slate-200">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10">
            ...
            <p className="text-slate-600 text-base sm:text-lg max-w-3xl mt-3 leading-relaxed">
              Explore painting, civil work, and flooring projects completed by Roshan Enterprises in Noida, Greater Noida, and Delhi NCR.
            </p>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredProjects.map((proj) => (
                <div
                  key={proj.id}
                  className="bg-white border-2 border-slate-200 rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col justify-between group"
                >
                  <div>
                    {/* Image Container */}
                    ...
                    <div className="p-6 space-y-3">
                      ...
                      <div className="pt-2 flex flex-col space-y-1">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {proj.scope.map((s, i) => (
                            <span key={i} className="text-[11px] font-semibold bg-slate-100 border border-slate-200 px-2 py-0.5 text-navy-primary rounded-lg">
                              ✓ {s}
                            </span>
                          ))}
                        </div>
